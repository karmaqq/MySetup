...
/* ─────────────────── Şifre İkon Sıfırlama ─────────────────── */

function resetTogglePasswordIcon(btn) {
  const tmpl = document.getElementById("svg-eye");
  btn.innerHTML = "";
  if (tmpl) btn.appendChild(tmpl.content.cloneNode(true));
}
